...
const homeongoing = props => {
  ...
  useEffect(async () => {
    ...
    //  setAuthtoken(a.id)
    fetch(
      'https://obn1qqspll.execute-api.us-east-1.amazonaws.com/dev/user/post/get?user_id=' +
        userid,
      {
        method: 'GET',
        headers: {
                ...
                <View style={styles.modalview}>
                  <View style={styles.modalview1}>
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        toggleModal();
                        props.navigation.navigate('editongoing', {currentPost});
                      }}>
          ...
          <View style={styles.detailview}>
            <View style={styles.detail}>
              ...
              <View style={styles.touch}>
                <TouchableOpacity
                  onPress={() => props.navigation.navigate('homeongoing1')}>
            ...
            <View style={styles.pointview}>
              ...
              <TouchableOpacity
                onPress={() => props.navigation.navigate('applicantprofile')}>
