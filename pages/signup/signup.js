...
const signup = props => {
  ...
  sendcred = () => {
    ...
    fetch(
      'https://obn1qqspll.execute-api.us-east-1.amazonaws.com/dev/user/signup',
      {
        method: 'POST',
        headers: {
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView>
            ...
            <View style={styles.SectionStyle}>
              ...
              <TouchableOpacity onPress={updateSecureTextEntry}>
                {data.secureTextEntry ? (
                  <Icon name="eye-off-outline" size={30} />
                ) : (
        ...
        <View style={styles.send}>
          <TouchableOpacity style={styles.sendbtn} onPress={() => sendcred()}>
