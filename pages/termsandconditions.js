...
const termsandconditions = ({navigation}) => {
  return (
    ...
    <View style={styles.center}>
        <View style={{justifyContent:'center',alignItems:'center',marginLeft:wp('5%'),marginEnd:wp('5%'),marginTop:hp('3%')}}>
        ...
        <View style={{justifyContent:'center',alignItems:'center',marginLeft:wp('5%'),marginEnd:wp('5%'),marginTop:hp('2%'),}}>
    ...
    <View style={styles.center}>
    <View style={{justifyContent:'center',alignItems:'center',marginTop:hp('4%'),alignSelf:'center',marginBottom:hp('2%')}}>
