...
import { View, StyleSheet, Text,Image,SafeAreaView, ToastAndroid,FlatList,TextInput,Button } from "react-native";
 ...
 <View style={styles.basic}>
        <RadioForm
         radio_props={events}
          ...
          labelStyle={{fontSize:moderateScale(12),width:wp('35%'),fontFamily:'Poppins-medium'}}
          disabled={false}
          formHorizontal={true}
...
<View style={styles.rawtext}>
    ...
    <Collapse style={{borderBottomWidth:0,borderTopWidth:0}}>
      ...
      <Icon
              ...
              <Text style={styles.titleidentity}>Language</Text>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader>
            <View style={styles.insidebox}>
              <Text style={styles.selectname}>American Sign Language</Text>
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/signlanguage.png')}>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader style={{marginLeft:wp('3%')}}>
            <View style={styles.insidebox}>
              ...
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/arab.png')}>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader>
            <View style={styles.insidebox}>
              ...
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/greece.png')}>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader style={{marginLeft:wp('3%')}}>
            <View style={styles.insidebox}>
              ...
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/latin.png')}>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader>
            <View style={styles.insidebox}>
              ...
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/japan.png')}>
  ...
  <View style={styles.collapsebox}>
    <Collapse style={{borderBottomWidth:0,borderTopWidth:0}}>
      ...
      <Icon
              ...
              <Text style={styles.titleidentity}>Math</Text>
              <View style={styles.removeicon}>
      ...
      <CollapseBody style={styles.colbody}>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader style={{marginLeft:wp('3%')}}>
            <View style={styles.insidebox}>
              <Text style={styles.selectname}>Statistics And Probability</Text>
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/arab.png')}>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader>
            <View style={styles.insidebox}>
              <Text style={styles.selectname}>Applied Integrated Mathematics</Text>
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/greece.png')}>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader>
            <View style={{justifyContent:'flex-start',alignItems:'flex-start',flexDirection:'row',borderRadius:5,backgroundColor:'rgb(245,245,245)',marginTop:hp("2%"),padding:4,width:wp('80%')}}>
              <Text style={styles.selectname}>Calculus/ Pre-Calculus/ Multivariable
Calculus💯</Text>
        ...
        <Collapse style={{flexDirection:'row',}}>
          <CollapseHeader>
            <View style={styles.insidebox}>
              <Text style={styles.selectname}>Geometry And Trigonometry</Text>
              <View style={styles.selecticon}>
              <Image style={styles.icons}
        source={require('../assets/image/japan.png')}>
