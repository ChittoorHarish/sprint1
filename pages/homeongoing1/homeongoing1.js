...
const homeongoing1 = props => {
  ...
  useEffect(async () => {
    ...
    //  setAuthtoken(a.id)
    fetch(
      'https://obn1qqspll.execute-api.us-east-1.amazonaws.com/dev/user/post/applicant?post_id=' +
        postid,
      {
        method: 'GET',
        headers: {
          ...
          <View style={styles.bodyview}>
            ...
            <View style={styles.captionview}>
              <Text style={styles.description}>
                {data
                  ? data.description
                  : "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of lorm."}
              </Text>
            </View>
          ...
          <View style={styles.detailview}>
            ...
            <View style={styles.pointview}>
              ...
              {estado ? (
                ...
                <View style={styles.procontainerchange}>
                  <Text style={styles.points}>View Profile</Text>
                </View>
              )}
            </View>
            ...
            <View style={styles.chatbutton}>
              {estado ? (
                <TouchableOpacity
                  style={styles.vidaudtouch}
                  onPress={() => refRBSheet.current.open()}>
                  <Text style={styles.vidaudtext}>
                    Switch - Video/Audio call
                  </Text>
                </TouchableOpacity>
              ) : (
                <Text style={styles.vidaudtextinact}>
                  Switch - Video/Audio call
                </Text>
              )}
              <RBSheet
                ...
                <View style={styles.rawtext}>
                  <Text style={styles.change}>
                    Want to change preferred communication
                  </Text>
                  <Text style={styles.change}>
                    channel to Video call / Audio call
                  </Text>
                </View>
                ...
                <View style={styles.switch}>
                  <View style={styles.switchtext}>
                    ...
                    <Text style={styles.bottext}>
                      This can be changed in profile settings
                    </Text>
                  </View>
